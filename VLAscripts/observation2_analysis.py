# Analysis script of the 2nd VLA epoch of LS V +44 17. 
...
#
# execfile('observation2_analysis.py')
#
...
# -------------------------------------------------------------------------------
# 
myvis="22B-051.sb43265520.eb43279195.59954.08478440972.ms"
mylabel='RXJ0440.obs2.59954'
#
# -------------------------------------------------------------------------------
...
flagdata(vis=myvis, spw='55~65', antenna='ea13&ea23')
flagdata(vis=myvis, spw='55~65', antenna='ea06&ea28')
flagdata(vis=myvis, spw='55~65', antenna='ea20&ea26')
flagdata(vis=myvis, spw='62:50~62')
flagdata(vis=myvis, spw='63')
flagdata(vis=myvis, spw='44:31~62')
flagdata(vis=myvis, spw='34~65', antenna='ea24')
...
flagdata(vis=myvis, spw='18~33', antenna='ea02')
flagdata(vis=myvis, spw='18~33', antenna='ea10')
flagdata(vis=myvis, spw='21')
flagdata(vis=myvis, spw='33:0~31')
flagdata(vis=myvis, spw='15:50~62')
flagdata(vis=myvis, spw='20:18~36')
flagdata(vis=myvis, spw='29:45~62')
flagdata(vis=myvis, spw='3:62')
flagdata(vis=myvis, spw='4:62')
flagdata(vis=myvis, spw='5:62')
flagdata(vis=myvis, spw='6:62')
flagdata(vis=myvis, spw='7:62')
flagdata(vis=myvis, spw='8:62')
flagdata(vis=myvis, spw='4')
flagdata(vis=myvis, spw='5:0~6')
flagdata(vis=myvis, spw='5:19~26')
flagdata(vis=myvis, spw='2~5', antenna='ea23&ea27')
flagdata(vis=myvis, spw='18:20~40')
flagdata(vis=myvis, spw='27:41~42')
flagdata(vis=myvis, spw='28:29~36')
flagdata(vis=myvis, spw='28:50~62')
flagdata(vis=myvis, spw='29', antenna='ea23&ea27')
flagdata(vis=myvis, spw='30:0~14')
#
# -------------------------------------------------------------------------------
# STEP 2: Calibration
# -------------------------------------------------------------------------------
