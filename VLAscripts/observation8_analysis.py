# Analysis script of the 8th VLA epoch of LS V +44 17. 
...
#
# execfile('observation8_analysis.py')
#
...
# -------------------------------------------------------------------------------
# 
myvis='22B-051.sb43592789.eb43600570.59980.142572372686.ms'
mylabel='RXJ0440.obs8.59980'
#
# -------------------------------------------------------------------------------
...
flagdata(vis=myvis, spw='59~65', antenna='ea11&ea23')
flagdata(vis=myvis, spw='62~65')
flagdata(vis=myvis, spw='61:30~61')
flagdata(vis=myvis, spw='5:60~62')
flagdata(vis=myvis, spw='12:60~62')
flagdata(vis=myvis, spw='4:60~62')
flagdata(vis=myvis, spw='4:0~10')
flagdata(vis=myvis, spw='5:0~10')
flagdata(vis=myvis, spw='16', antenna='ea06')
flagdata(vis=myvis, spw='16:24~35')
flagdata(vis=myvis, spw='19')
flagdata(vis=myvis, spw='11:58~62')
flagdata(vis=myvis, spw='12:0~3')
flagdata(vis=myvis, spw='15:50~62')
flagdata(vis=myvis, spw='16')
flagdata(vis=myvis, spw='17:58~62')
flagdata(vis=myvis, spw='18~25', antenna='ea05')
flagdata(vis=myvis, spw='21:0~30')
flagdata(vis=myvis, spw='33:15~30')
flagdata(vis=myvis, spw='4')
flagdata(vis=myvis, spw='21:60~62')
flagdata(vis=myvis, spw='23:0~31')
flagdata(vis=myvis, spw='18:20~40')
flagdata(vis=myvis, spw='20:19~35')
flagdata(vis=myvis, spw='30:20~45')
flagdata(vis=myvis, spw='33')
#
# -------------------------------------------------------------------------------
# STEP 2: Calibration
# -------------------------------------------------------------------------------
...
gaincal(vis=myvis, caltable=mylabel+'.Cband'+'.G0all', field='0,1', refant='ea07', spw=SPW+':10~50', gaintype='G', calmode='p', solint='int', minsnr=5, append=False)
gaincal(vis=myvis, caltable=mylabel+'.Cband'+'.G0', field='0', refant='ea07', spw=SPW+':10~50', calmode='p', solint='int', minsnr=5)
gaincal(vis=myvis,caltable=mylabel+'.Cband'+'.K0', gaintable=[mylabel+'.Cband'+'.G0'], field='0',spw=SPW+':1~61',gaintype='K', refant='ea07', combine='scan', solint='inf', minsnr=3)

bandpass(vis=myvis,caltable=mylabel+'.Cband'+'.B0', gaintable=[mylabel+'.Cband'+'.G0',mylabel+'.Cband'+'.K0'], field='0', spw=SPW, refant='ea07',solnorm=True, bandtype='B', combine='scan', solint='inf')
gaincal(vis=myvis, caltable=mylabel+'.Cband'+'.G1', gaintable=[mylabel+'.Cband'+'.K0',mylabel+'.Cband'+'.B0'], field='0', refant='ea07', solnorm=False, spw=SPW+':1~61', solint='inf', gaintype='G', calmode='ap', append=False)
gaincal(vis=myvis,caltable=mylabel+'.Cband'+'.G1', gaintable=[mylabel+'.Cband'+'.K0', mylabel+'.Cband'+'.B0'], field='1', refant='ea07', solnorm=False, spw=SPW+':1~61', solint='inf', gaintype='G',calmode='ap', append=True)
