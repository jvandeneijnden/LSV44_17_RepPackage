# Analysis script of the 6th VLA epoch of LS V +44 17. 
...
#
# execfile('observation6_analysis.py')
#
...
# -------------------------------------------------------------------------------
# 
myvis="22B-051.sb43430329.eb43433958.59965.14267939815.ms"
mylabel='RXJ0440.obs6.59965'
#
# -------------------------------------------------------------------------------
...
#
flagdata(vis=myvis, spw='33', antenna='ea17')
flagdata(vis=myvis, spw='33')
flagdata(vis=myvis, spw='44:30~62')
flagdata(vis=myvis, spw='57~65', antenna='ea07')
flagdata(vis=myvis, spw='57~65', antenna='ea26')
flagdata(vis=myvis, spw='57~65', antenna='ea11')
flagdata(vis=myvis, spw='57~65', antenna='ea23')
flagdata(vis=myvis, spw='63~65')
flagdata(vis=myvis, spw='59:30~62')
flagdata(vis=myvis, spw='16')
flagdata(vis=myvis, spw='15:50~62')
flagdata(vis=myvis, spw='18~33', antenna='ea05&ea06')
...
flagdata(vis=myvis, spw='17~22', antenna='ea23')
...
flagdata(vis=myvis, spw='6:35~50')
flagdata(vis=myvis, spw='11:60~62')
flagdata(vis=myvis, spw='12:0~5')
flagdata(vis=myvis, spw='17:15~35')
flagdata(vis=myvis, spw='17:54~62')
