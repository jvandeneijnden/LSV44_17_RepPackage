# Analysis script of the 3rd VLA epoch of LS V +44 17. 
...
#
# execfile('observation3_analysis.py')
#
...
# -------------------------------------------------------------------------------
# 
myvis="22B-051.sb43281063.eb43326505.59956.1770187963.ms"
mylabel='RXJ0440.obs3.59956'
#
# -------------------------------------------------------------------------------
...
flagdata(vis=myvis, spw='57~65', antenna='ea06&ea20')
flagdata(vis=myvis, spw='57~65', antenna='ea11&ea16')
flagdata(vis=myvis, spw='57~65', antenna='ea13&ea25')
flagdata(vis=myvis, spw='57~65', antenna='ea27&ea28')
flagdata(vis=myvis, spw='57~65', antenna='ea13&ea17')
flagdata(vis=myvis, spw='57~65', antenna='ea20')
flagdata(vis=myvis, spw='57~65', antenna='ea06')
flagdata(vis=myvis, spw='62~63')
flagdata(vis=myvis, spw='44:31~62')
flagdata(vis=myvis, spw='34~65', antenna='ea10')
flagdata(vis=myvis, spw='60~65', antenna='ea04&ea28')
flagdata(vis=myvis, spw='3:62')
flagdata(vis=myvis, spw='4:62')
flagdata(vis=myvis, spw='5:62')
flagdata(vis=myvis, spw='6:62')
flagdata(vis=myvis, spw='2~5', scan='5')
flagdata(vis=myvis, spw='15:50~61')
flagdata(vis=myvis, spw='18:20~40')
flagdata(vis=myvis, spw='20:18~36')
flagdata(vis=myvis, spw='21:0~31')
flagdata(vis=myvis, spw='33:20~32')
