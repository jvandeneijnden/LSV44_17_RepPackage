# Analysis script of the 4th VLA epoch of LS V +44 17. 
...
#
# execfile('observation4_analysis.py')
#
...
# -------------------------------------------------------------------------------
# 
myvis="22B-051.sb43353950.eb43374869.59958.11983386574.ms"
mylabel='RXJ0440.obs4.59958'
#
# -------------------------------------------------------------------------------
...
flagdata(vis=myvis, spw='59~65', scan='20')
flagdata(vis=myvis, spw='62:34~44')
flagdata(vis=myvis, spw='63')
flagdata(vis=myvis, spw='44:31~62')
flagdata(vis=myvis, spw='34~65', antenna='ea10')
flagdata(vis=myvis, spw='45:31~62')
flagdata(vis=myvis, spw='15:50~62')
flagdata(vis=myvis, spw='20:18~38')
flagdata(vis=myvis, spw='21:0~31')
flagdata(vis=myvis, spw='3:62')
flagdata(vis=myvis, spw='4:62')
flagdata(vis=myvis, spw='5:62')
flagdata(vis=myvis, spw='6:62')
flagdata(vis=myvis, spw='2~6', scan='11')
flagdata(vis=myvis, spw='4')
flagdata(vis=myvis, scan='13', antenna='ea22')
flagdata(vis=myvis, scan='13', antenna='ea10')
flagdata(vis=myvis, scan='13', antenna='ea02')
flagdata(vis=myvis, scan='13', antenna='ea17')
flagdata(vis=myvis, spw='5:0~5')
flagdata(vis=myvis, spw='5:19~26')
flagdata(vis=myvis, spw='17:15~30')
flagdata(vis=myvis, spw='18:20~36')
flagdata(vis=myvis, spw='33:18~30')
flagdata(vis=myvis, spw='12:62')
flagdata(vis=myvis, spw='3:45~50')
flagdata(vis=myvis, spw='5:0~4')
flagdata(vis=myvis, spw='5:18~26')
flagdata(vis=myvis, spw='6:40~50')
flagdata(vis=myvis, spw='11:20~32')
flagdata(vis=myvis, spw='11:58~62')
flagdata(vis=myvis, spw='12:0~10')
flagdata(vis=myvis, spw='17:16~32')
flagdata(vis=myvis, spw='2~3', antenna='ea06&ea23')
flagdata(vis=myvis, spw='18:20~40')
flagdata(vis=myvis, spw='28:29~62')
flagdata(vis=myvis, spw='29:50~62')
flagdata(vis=myvis, spw='30:0~15')
#
# -------------------------------------------------------------------------------
# STEP 2: Calibration
# -------------------------------------------------------------------------------
