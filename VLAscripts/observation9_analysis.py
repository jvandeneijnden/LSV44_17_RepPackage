# Analysis script of the 9th VLA epoch of LS V +44 17. 
...
#
# execfile('observation9_analysis.py')
#
...
# -------------------------------------------------------------------------------
# 
myvis='22B-051.sb43637459.eb43642328.59989.050631446764.ms'
mylabel='RXJ0440.obs9.59989'
#
# -------------------------------------------------------------------------------
...
#
flagdata(vis=myvis, spw='44')
flagdata(vis=myvis, spw='62~65')
flagdata(vis=myvis, spw='45:19~26')
flagdata(vis=myvis, spw='45:27~34')
flagdata(vis=myvis, spw='45:60~62')
flagdata(vis=myvis, spw='45:0~19')
flagdata(vis=myvis, spw='16')
flagdata(vis=myvis, spw='19')
flagdata(vis=myvis, spw='18', antenna='ea02')
flagdata(vis=myvis, spw='20', antenna='ea02')
flagdata(vis=myvis, spw='15:50~62')
flagdata(vis=myvis, spw='5:15~30')
flagdata(vis=myvis, spw='17:15~35')
flagdata(vis=myvis, spw='2~3', antenna='ea06&ea23')
flagdata(vis=myvis, spw='2~3', antenna='ea05&ea06')
flagdata(vis=myvis, spw='4:0~15')
flagdata(vis=myvis, spw='4:46~62')
flagdata(vis=myvis, spw='5:0~15')
flagdata(vis=myvis, spw='3:46~49')
flagdata(vis=myvis, spw='3:40~50')
flagdata(vis=myvis, spw='17:50~62')
flagdata(vis=myvis, spw='11:22~32')
flagdata(vis=myvis, spw='12:19~30')
flagdata(vis=myvis, spw='18:28~38')
flagdata(vis=myvis, spw='20:20~35')
flagdata(vis=myvis, spw='21:0~16')
flagdata(vis=myvis, spw='33:18~32')
flagdata(vis=myvis, spw='18:20~45')
flagdata(vis=myvis, spw='20:18~19')
