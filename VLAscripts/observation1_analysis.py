# Analysis script of the first VLA epoch of LS V +44 17. 
...
# execfile('observation1_analysis.py')
...
# -------------------------------------------------------------------------------
# 
myvis="22B-051.sb43249520.eb43264909.59951.125568483796.ms"
mylabel='RXJ0440.obs1.59951' 
#
# -------------------------------------------------------------------------------
...
#
flagdata(vis=myvis, scan='1~3') # Setup scans
flagdata(vis=myvis, scan='14~15') # Setup scans
flagdata(vis=myvis, spw='0~1') # Setup spws
#
...
flagdata(vis=myvis, spw='44:50~62')
flagdata(vis=myvis, spw='16')
flagdata(vis=myvis, spw='19')
flagdata(vis=myvis, spw='20:18~36')
flagdata(vis=myvis, spw='21:0~30')
flagdata(vis=myvis, spw='44:32~62')
flagdata(vis=myvis, spw='62~65', antenna='ea05&ea11')
flagdata(vis=myvis, spw='62:35~40')
flagdata(vis=myvis, spw='62:55~62')
flagdata(vis=myvis, spw='63:0~10')
flagdata(vis=myvis, spw='63:45~50')
flagdata(vis=myvis, spw='4:25~35')
flagdata(vis=myvis, spw='5:19~27')
flagdata(vis=myvis, spw='15:55~62')
flagdata(vis=myvis, spw='18:20~40')
flagdata(vis=myvis, spw='29:50~62')
flagdata(vis=myvis, spw='30:0~10')
flagdata(vis=myvis, spw='33:18~30')
flagdata(vis=myvis, antenna='ea17', spw='2~33')
flagdata(vis=myvis, spw='59:30~62')
flagdata(vis=myvis, spw='60~65')
...
flagdata(vis=myvis, spw='3:55~62')
...
#
SPW = '0~31' # Note: the spw numbers reset once the data is split off, so 34~65 becomes 0~31.
...
tclean(vis=myvis, imagename=mylabel+'.im1', imsize=2048, cell='0.25arcsec', stokes='I', specmode='mfs',deconvolver='hogbom', robust=0., weighting='briggs', niter=4000, cycleniter=200, interactive=False, threshold='0.015 mJy')
#
# -------------------------------------------------------------------------------
# FINISHED
# -------------------------------------------------------------------------------
